          ...
          <form className="mx-1 mx-md-4">
            ...
            <div className="d-flex flex-row align-items-center mb-4">
              ...
              <div className="form-outline flex-fill mb-0">
                <input type="text" {...register("name",{ required: true })} name="name"  value={input.name} onChange={ event=>setInput({...input,name:event.target.value})} id="form3Example1c" className="form-control" required />
            ...
            <div className="d-flex flex-row align-items-center mb-4">
              ...
              <div className="form-outline flex-fill mb-0">
                <input type="email"  {...register("email",{ required: true })} name="email" value={input.email}  onChange={event=>setInput({...input,email:event.target.value})} id="form3Example3c" className="form-control" required/>
            ...
            <div className="d-flex flex-row align-items-center mb-4">
              ...
              <div className="form-outline flex-fill mb-0">
                <input type="text"  {...register("number",{ required: true })} name="number" value={input.number}  onChange={event=>setInput({...input,number:event.target.value})} id="form3Example4c" className="form-control" required/>
